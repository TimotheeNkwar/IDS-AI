...
\begin{titlepage}
  ...
  {\large\bfseries FACULTY OF APPLIED SCIENCE}\\[6pt]
  ...
  {\large\bfseries TAmirHaidar Rahmani (22205704)}\\
  {\large\bfseries Bashir Bashir Garuba (22209139)}\\
...
\begin{titlepage}
  ...
  \vspace{1.0cm}
  {\Large\bfseries CYPRUS INTERNATIONAL UNIVERSITY}\\[6pt]
  {\large\bfseries FACULTY OF ENGINEERING}\\[6pt]
  {\large\bfseries DEPARTMENT OF COMPUTER ENGINEERING}\\[0.8cm]
...
\begin{titlepage}
  ...
  \vspace{1cm}
  \begin{flushleft}
  \textbf{DATE OF APPROVAL:} \underline{15 June 2026}
  \end{flushleft}

  \vspace{1.5cm}
  \begin{flushleft}
  \textbf{APPROVED BY:} \\[1.2cm]
  
  \noindent\rule{6cm}{0.4pt} \\
  (Asst./Assoc.) Prof.Dr. Instructor Name \\
  Project Supervisor \\[1cm]
  
  \noindent\rule{6cm}{0.4pt} \\
  Committee Member 1 \\[1cm]
