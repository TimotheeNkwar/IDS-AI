...
async def get_stats(hours: int = Query(ge=1, le=720)) -> JSONResponse:
    data = {
...
async def get_alert_stats(hours: int = Query(ge=1, le=720)) -> JSONResponse:
    data = {
...
async def get_traffic_stats(hours: int = Query(ge=1, le=720)) -> JSONResponse:
    data = {
...
async def get_traffic_summary(hours: int = Query(ge=1, le=720)) -> JSONResponse:
