      ...
      <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="max-w-2xl">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div>
              <div className="flex items-center gap-1 mb-1 text-fuchsia-400 light:text-fuchsia-500">
          ...
          <p className="text-sm md:text-base text-slate-400 light:text-slate-500 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                className="
                  appearance-none w-full sm:w-44 h-11
                  rounded-2xl border px-4 pr-10
              ...
              <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 light:text-slate-400 pointer-events-none" />
            </div>
          </div>
